...
Процедура ВыполнитьПриложение()
    ...
    Приложение = Новый КонсольноеПриложение("rce", "Консольный исследователь сайта releases.1c.ru");
    ...
    Приложение.ДобавитьКоманду("n news", "Что нового (последние обновления, свежие резилы)", Новый КомандаПоказатьСвежиеРелизы);
    Приложение.ДобавитьКоманду("d download", "Скачать", Новый КомандаСкачать);
